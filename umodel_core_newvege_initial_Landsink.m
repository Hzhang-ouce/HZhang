function Annual_record = umodel_core_newvege_initial_Landsink (Path,Global_temperature_setting,Soil_respiration_equation,C_soil_option)
...
load NPP\initial_landsink_year31_06.mat
NPP_1903_plus_landsink=NPP_1903-initial_landsink;
switch C_soil_option
    case 'Soilgrids'
    %PgC
    K_2 =NPP_1903_plus_landsink./LT.Csoil./LT.func(Temperature);%note that K_2 and LT.func dont have unit
C_soil=NPP_1903_plus_landsink./K_2./LT.func(Temperature);%KgC/m2
    otherwise
    K_2 =sum(sum(Area_WGS_1984_05degree.*NPP_1903_plus_landsink./LT.func(Temperature),'omitnan'),'omitnan' )./(LT.Csoil*10^12);%note that K_2 and LT.func dont have unit
    C_soil=NPP_1903_plus_landsink./K_2./LT.func(Temperature);%KgC/m2
end
%% model sign up
